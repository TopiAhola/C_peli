...
-o C:\Repositiot\c_peli\C_peli\Build_environment\Build_current\win32_game_cpp_version.exe ^
-L C:\Koodaus\C_compilers\MSYS2\ucrt64\lib -l gdi32 -l user32 -l onecore ^
