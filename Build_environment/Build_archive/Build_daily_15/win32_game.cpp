...
#include <C:\Users\valas\VSCProjects\C_peli\Build_environment\Build_daily_15\game.cpp>
...
//Write a whole file
internal bool
platform_write_file(char* filename, uint64 size, void * memory){
...
int CALLBACK WinMain(
    ...
    { // Class has to be registered ? Function retruns an "ATOM" type thing but it isnt needed?
        ...
        {   
            ...
            //Struct for passing all inputs to the game
            game_input input;
