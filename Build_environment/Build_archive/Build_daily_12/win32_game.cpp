...
#include <C:\Users\valas\VSCProjects\C_peli\Build_environment\Build_daily_12\game.cpp>
...
int CALLBACK WinMain(
    ...
    { // Class has to be registered ? Function retruns an "ATOM" type thing but it isnt needed?
        ...
        {   
            ...
            game_sound_output.memory_p = (int16*) VirtualAlloc(0, game_sound_output.size, MEM_COMMIT, PAGE_READWRITE);
            ...
            while(program_running)
            {
                ...
                game_update_and_render(&bitmap, &game_sound_output, samples_used, kb_x_input, kb_y_input); 
