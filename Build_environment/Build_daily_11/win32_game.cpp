...
#include <C:\Users\valas\VSCProjects\C_peli\Build_environment\Build_daily_11\game.cpp>
    ...
    { // Class has to be registered ? Function retruns an "ATOM" type thing but it isnt needed?
        ...
        {   
            ...
            while(program_running)
            {
                ...
                game_backbuffer * bitmap_p = & bitmap;
                ...
                game_update_and_render(bitmap_p, kb_x_input, kb_y_input);
                window_dimensions dimensions = get_window_dimensions(window);
